...
class XExecution(AExecution):
    ...
    def __init__(self, _C):
        ...
        self.logger = _log_init(name="logger", level=logging.INFO,
        ...
        self.logger.info("Num of samples of {} dataset :{}".format(_C.DATA.split,len(self.dataset)))
        ...
        if _C.EXECUTION.is_valid:
            ...
            self.logger.info("Num of samples of eval dataset :{}".format(len(self.eval_dataset)))
        else:
